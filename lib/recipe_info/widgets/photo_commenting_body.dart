              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(Insets.horizontal1, 0, Insets.horizontal1, 30),
                      child: TextField(
                        controller: textController,
                        maxLines: 2,
                        textInputAction:
                            kIsWeb ? TextInputAction.search : TextInputAction.done,
                        decoration: const InputDecoration(
                          hintText: RecipeInfoTexts.commentInputHint,
                          hintStyle: TextStyle(color: AppColors.main, fontSize: 16),
                        ...
                        onSubmitted: (text) {
                          ...
                          final user =
                              BlocProvider.of<BaseAuthCubit>(context).state.user!;
                          final recipe =
                              BlocProvider.of<BaseRecipeInfoCubit>(context).recipe;
