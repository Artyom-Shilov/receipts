...
class RecipeTopColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<BaseFavouriteCubit>(
          ...
          Row(
            ...
            children: [
              ...
              if (BlocProvider.of<BaseAuthCubit>(context).isLoggedIn())
                BlocBuilder<BaseFavouriteCubit, FavouriteState>(
                  builder: (context, state) => IconButton(
                    icon: const Icon(Icons.favorite),
                    color: state.isFavourite ? Colors.red : Colors.black,
                    onPressed: () {
                      BlocProvider.of<BaseFavouriteCubit>(context).changeFavouriteStatus();
                    },
                  ),
                )
            ],
